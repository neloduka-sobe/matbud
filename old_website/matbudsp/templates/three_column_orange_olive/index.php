...
<div class="logo">
 <h1 id="name-text" class="logo-name"><a href="<?php echo $this->baseurl ?>/">free joomla templates</a></h1>
 <div id="slogan-text" class="logo-text">download for free</div>
</div>
...
All Rights Reserved.</p>
 ...
 <div class="Footer-background"></div>
  ...
  <p class="page-footer"><a href="http://joomlacmstemplates.blogspot.com/" title="joomla templates download">Free Joomla CMS Templates</a></p>
