  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td id="content_outer" valign="top"><table align="center" border="0" cellpadding="0" cellspacing="0" class="content_table">
        ...
        <div align="center">
          <div id="copy">
            <div id="copy_inner" class="copy_inner"><strong><a href="" target="_blank"></a></strong><strong><a href="http://jigsaw.w3.org/css-validator/check?uri=templates/<?php echo $this->template ?>/css/template.css" target="_blank"></a></strong> <strong> </strong>  <strong><a href="<?php echo $this->params->get('TemplateDesignLink') ?>" target="_blank"><?php echo  $this->params->get('TemplateDesign');  ?></a></strong> <strong> </strong> Copyright &copy; <?php echo  $this->params->get('CopyrightJahr');  ?> by <strong><a href="<?php echo $this->params->get('CopyrightLink') ?>" target="_self"><?php echo  $this->params->get('Copyright');  ?></a></strong></div>
          </div>
        </div></td>
    </tr>
  </table>
