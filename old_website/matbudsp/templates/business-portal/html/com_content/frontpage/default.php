	...
	<td valign="top">
		...
		<?php
			...
			for ($z = 0; $z < $this->params->def('num_columns', 2); $z ++) :
				...
				$style = ($z > 0) ? "padding-left:5px" : "padding-right:5px";
			?>
				<td valign="top" style="<?php echo $style; ?>" width="<?php echo intval(100 / $this->params->get('num_columns')) ?>%" class="article_column<?php echo $divider ?>">
