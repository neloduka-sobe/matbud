...
<div class="logo">
 <h1 id="name-text" class="logo-name"><a href="<?php echo $this->baseurl ?>/">Free Joomla 1.5 Templates</a></h1>
 <div id="slogan-text" class="logo-text">http://joomlacmstemplates.blogspot.com</div>
</div>
...
All Rights Reserved.</p>
 ...
 <div class="Footer-background"></div>
  ...
  <p class="page-footer"><a href="http://joomlacmstemplates.blogspot.com">Joomla 1.5 Templates</a> download for free.</p>
